analyzer=SkimTree_HNFakeInclusive
rundir=runSkims
...
if [[ $1 == "" ]]; then
	...
	SKFlat.py -a $analyzer  -i TTLJ_powheg                     -n ${njobs}  --nmax ${nmax}   -e ${i} --skim SkimTree_HNFake
	...
	SKFlat.py -a $analyzer  -i WJets_amcatnlo  -n ${njobs}       --nmax ${nmax}   -e ${i} --skim SkimTree_HNFake&
        SKFlat.py -a $analyzer  -i WJets_Sherpa   -n ${njobs}       --nmax ${nmax}   -e ${i} --skim SkimTree_HNFake&
        SKFlat.py -a $analyzer  -i WJets_MG -n ${njobs}       --nmax ${nmax}   -e ${i} --skim SkimTree_HNFake
