...
if [[ $1 == "" ]]; then
	...
	SKFlat.py -a $analyzer  -l $mcpath/WConv.txt         -n 40        --nmax ${nmax}   -e ${i} --skim SkimTree_HNMultiLepBDT  --userflags SSMultiLep,RunConv&
	SKFlat.py -a $analyzer  -i  DYJets_MG                -n 40        --nmax ${nmax}   -e ${i} --skim SkimTree_HNMultiLepBDT  --userflags SSMultiLep,RunConv&
	SKFlat.py -a $analyzer  -l $mcpath/DYConv.txt        -n 50        --nmax ${nmax}   -e ${i} --skim SkimTree_HNMultiLepBDT  --userflags SSMultiLep,RunConv&
	...
	SKFlat.py -a $analyzer  -l $mcpath/WConv.txt         -n 40        --nmax ${nmax}   -e ${i} --skim SkimTree_HNMultiLepBDT  --userflags SSMultiLep,RunConv,GENTConv&
        SKFlat.py -a $analyzer  -i  DYJets_MG                -n 40        --nmax ${nmax}   -e ${i} --skim SkimTree_HNMultiLepBDT  --userflags SSMultiLep,RunConv,GENTConv&
        SKFlat.py -a $analyzer  -l $mcpath/DYConv.txt        -n 50        --nmax ${nmax}   -e ${i} --skim SkimTree_HNMultiLepBDT  --userflags SSMultiLep,RunConv,GENTConv&
        SKFlat.py -a $analyzer  -l $mcpath/Conv.txt          -n 20        --nmax ${nmax}   -e ${i} --skim SkimTree_HNMultiLepBDT  --userflags SSMultiLep,RunConv,GENTConv&
        SKFlat.py -a $analyzer  -l $mcpath/Conv2.txt         -n 100        --nmax ${nmax}   -e ${i} --skim SkimTree_HNMultiLepBDT  --userflags SSMultiLep,RunConv,GENTConv&
