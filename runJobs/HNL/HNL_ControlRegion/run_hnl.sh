...
if [[ $1 == "" ]]; then
    ...
    do
        ...
        do
            ...
            SKFlat.py -a $analyzer  -i DYJets_MG              -n 10        --nmax ${nmax}   -e ${i} --skim SkimTree_HNMultiLepBDT   --userflags  ScanFakes,RunConv,${j}&
	    SKFlat.py -a $analyzer  -i WJets_MG              -n 10        --nmax ${nmax}   -e ${i} --skim SkimTree_HNMultiLepBDT   --userflags  ScanFakes,RunConv,${j}&
