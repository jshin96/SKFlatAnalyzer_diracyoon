...
do
    ...
    #SKFlat.py -a $analyzer  -i WJets_MG          -n 600  --nmax 500   -e ${i}  --skim SkimTree_BDT --userflags ShiftEnergy&
    #SKFlat.py -a $analyzer  -i WJets_amcatnlo    -n 600  --nmax 500   -e ${i}  --skim SkimTree_BDT --userflags ShiftEnergy&
