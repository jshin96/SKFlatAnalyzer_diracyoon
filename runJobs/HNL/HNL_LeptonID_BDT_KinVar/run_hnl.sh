...
if [[ $1 == "" ]]; then
	...
	#SKFlat.py -a $analyzer  -l   $mcpath/Fake2.txt  -n 300  --nmax ${nmax}   -e ${i}  --userflags SeperateFake,HFB &
	#SKFlat.py -a $analyzer  -l   $mcpath/Fake2.txt  -n 300  --nmax ${nmax}   -e ${i}  --userflags SeperateFake,HFC &
	SKFlat.py -a $analyzer  -l   $mcpath/Fake2.txt  -n 300  --nmax ${nmax}   -e ${i}  --userflags SeperateFake,LF & 
	SKFlat.py -a $analyzer  -l   $mcpath/Fake2.txt  -n 300  --nmax ${nmax}   -e ${i}  --userflags SeperateFake &
