...
AnalysisCode="ExampleRun" #"TestRun" #"KinVarSearch" "KinVarPlot" 
FinalState="" #"DiMuon" #ElDiMu / TriMu / TriLep / TetraLep / DiMuon
Skim="" #"SkimTree_SS2lOR3l"
Year="2016a"
RunningMode="" #"SS2l,SSMuMu" #MuMuMu / ElMuMu / TriLep / TetraLep / SS2l
