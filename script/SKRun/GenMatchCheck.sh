...
AnalysisCode="GenMatchingValid" 
FinalState="Muon" #ElDiMu / TriMu / TetraLepton / DiMuon
Skim=""
Year="2017"
RunningMode="LepTypeValid" #"LepTypeValid" #"PhotonMatch" #MuMuMu / ElMuMu / TetraLep / SS2l
