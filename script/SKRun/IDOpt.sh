...
FinalState="Lepton" #"Electron" #"Muon"
Skim=""  #"SkimTree_SS2lOR3l"
Year="2017"
RunningMode="MultiIsoTest" #"ElEl,FakeRateCheck" #"ElEl,SelEffCheck" #"ElEl,TrigEffCheck" #"MuMu,SelEffCheck" #"ElTrigEffect" #"MuTrigEffect" #"MuID" #"ElTrigCut" #"MuID" #"ElID
