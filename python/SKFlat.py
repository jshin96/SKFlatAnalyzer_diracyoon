...
# new function added by jalmond: used to make skimmed samples
...
parser.add_argument('-t', dest='timestamp', default="")
parser.add_argument('-log', dest='logentry', default="-1")
...
parser.add_argument('--EventComparison', action='store_true')
parser.add_argument('--eventlists', dest='EventLists', default="") 
