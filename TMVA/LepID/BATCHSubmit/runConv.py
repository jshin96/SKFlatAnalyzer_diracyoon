                        ...
                        for AdaBoostBeta in AdaBoostBetaValues:
                            for Era in Eras:
                                for Channel in Channels:
                                    ...
                                    os.system("RunIDBDT.py -a runIDBDT_HNtypeIConv -ns "+str(SignalMode)+ "  -nt "+ str(NTREES) + " -c " + Channel + " -MaxDepth  " + str(MaxDepth) + " -ncut " + str(NCut) + NEG +  " -Nrom " +NormMode+ " -AdaBoostBeta " + AdaBoostBeta + " -e "+Era+" " + nMAX )    
