                                ...
                                for BaggedFracs in BaggedFracs:
                                    for Era in Eras:
                                        for Channel in Channels:
                                            ...
                                            os.system("RunIDBDT.py -a runIDBDT_HNtypeI -m " + str(Classifier) + " -b Conv -ns "+str(SignalMode)+ "  -nt "+ str(NTREES) + " -c " + Channel + " -MaxDepth  " + str(MaxDepth) + " -ncut " + str(NCut) + NEG +  " -Nrom " +NormMode+ " -BoostLearningRate  " + BoostLearningValue + " -BaggedFrac " + BaggedFracs +  " -e "+Era+" " + nMAX )    
