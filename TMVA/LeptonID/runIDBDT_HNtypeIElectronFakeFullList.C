void runIDBDT_HNtypeIElectronFakeFullList(TString Classifier ="BDTG" ,TString BkgType = "FakeBkg", TString era="2016",TString channel="EE",  int signal_mode=10, TString NTrees="400", TString NormMode="EqualNumEvents", TString   MinNodeSize ="2.5", TString MaxDepth = "3", TString nCuts="300", TString BoostLearningRate="0.1", TString BaggedFrac="0.6", TString seed = "100",  int eta_mode= 0){
  ...
  TString JobTag = "Full_"+Classifier + "_version2_"+  "_"+ BkgType +"_"+ signal+"TypeI_"+channel+"_"+signal+"_"+era+"_NTrees"+NTrees+"_NormMode_"+NormMode+"_MinNodeSize_"+MinNodeSize+"_MaxDepth_"+MaxDepth+"_nCuts_"+nCuts+ClassTag +"_Seed_"+seed+"_BDT";
