...
void HNL_LeptonCore::GetSetup_HNLIDHEEP(AnalyzerParameter& param_default ){
  ...
  param_default.Muon_FR_ID        = "HNL_ULID_HEEP_FO";
  param_default.Electron_FR_ID    = "HNL_ULID_HEEP_FO";
  ...
  if(GetEra() == "2016preVFP"){
    param_default.k.Muon_FR            = "HNL_ULID_HEEP_FO_v1_a"+JFRJetPt+MuFRBin;
    param_default.k.Electron_FR        = "HNL_ULID_HEEP_FO_v9_a"+JFRJetPt+ElFRBin;
  }
  if(GetEra() == "2016postVFP"){
    param_default.k.Muon_FR            = "HNL_ULID_HEEP_FO_v2_a"+JFRJetPt+MuFRBin;
    param_default.k.Electron_FR        = "HNL_ULID_HEEP_FO_v9_a"+JFRJetPt+ElFRBin;
  }
  ...
  if(GetYearString() == "2018"){
    param_default.k.Muon_FR         = "HNL_ULID_FO_HEEP_v3_a"+JFRJetPt+MuFRBin;;
    param_default.k.Electron_FR     = "HNL_ULID_FO_HEEP_v9_a"+JFRJetPt+ElFRBin;
  }
