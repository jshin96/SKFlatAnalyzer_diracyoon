#include "HNL_IDSFTmp.h"

void HNL_IDSFTmp::initializeAnalyzer(){
...
void HNL_IDSFTmp::MeasureMuonIDSF(AnalyzerParameter param){
...
void HNL_IDSFTmp::MeasureElectronIDSF(AnalyzerParameter param){

  if(run_Debug) cout << "HNL_IDSFTmp::executeEvent " << endl;
...
void HNL_IDSFTmp::MeasureIDSF(HNL_LeptonCore::Channel dilep_channel, vector<Muon> MuonColl, TString ID, double weight_ll){
...
void HNL_IDSFTmp::MeasureIDSF(HNL_LeptonCore::Channel dilep_channel, vector<Electron> ElectronColl, TString ID, double weight_ll){
