#include "HNL_LepIDKinVarEtaBinned.h"

void HNL_LepIDKinVarEtaBinned::initializeAnalyzer(){
...
void HNL_LepIDKinVarEtaBinned::SetupTrees(TTree* tree_mm, TTree* tree_ee){
...
void HNL_LepIDKinVarEtaBinned::executeEvent(){
...
void HNL_LepIDKinVarEtaBinned::MakeTreeSS2L(HNL_LeptonCore::Channel lep_channel,vector<Lepton *>  LepTColl, 
				   vector<Muon> Muons, 
...
void HNL_LepIDKinVarEtaBinned::executeEventFromParameter(AnalyzerParameter param){

  
}


void HNL_LepIDKinVarEtaBinned::InitializeTreeVars(){
...
HNL_LepIDKinVarEtaBinned::HNL_LepIDKinVarEtaBinned(){
...
void HNL_LepIDKinVarEtaBinned::WriteHist(){
