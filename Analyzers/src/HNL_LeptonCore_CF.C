  ...
  for(auto i : leps) {
    if(i->IsBB()) {
      if(DataEra=="2016preVFP"){
        ...
        if(param.Electron_Tight_ID == "HNL_ULID_2016") _SF*= 1.27854 ;
	...
	if(param.Electron_Tight_ID == "HNL_ULID_2016") _SF*= 1.34035 ;
	if(param.Electron_Tight_ID == "TopHNSST")      _SF*= 0.79 ;
        ...
        if(param.Electron_Tight_ID == "HNL_ULID_2018") _SF*=  0.754886;
	...
	if(param.Electron_Tight_ID == "POGTight")      _SF*= 0.771518 ;
        ...
        if(param.Electron_Tight_ID == "HNL_ULID_2016") _SF*= 1.23574 ;
        ...
        if(param.Electron_Tight_ID == "HNL_ULID_2016") _SF*= 1.10426 ;
        ...
        if(param.Electron_Tight_ID == "HNL_ULID_2018") _SF*= 0.78659 ;
