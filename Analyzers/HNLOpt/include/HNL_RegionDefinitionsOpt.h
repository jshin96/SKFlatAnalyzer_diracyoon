...
class HNL_RegionDefinitionsOpt : public HNL_LeptonCore {
 ...
 public:
  ...
  TString RunSignalRegionAK4StringBDT(TString mn, HNL_LeptonCore::Channel channel, HNL_LeptonCore::ChargeType qq ,std::vector<Lepton *> LepTCol,   std::vector<Lepton*> leps_veto,std::vector<Jet> JetAllColl, std::vector<Jet> JetColl, std::vector<Jet> JetVBFColl, std::vector<Jet> B_JetColl, Event ev, Particle METv, AnalyzerParameter param, TString PostLabel ,  float w);
