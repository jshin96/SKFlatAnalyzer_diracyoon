...
void HNL_LeptonFakeRateMC::GetElFakeRates(TString Method, Lepton* lep,bool blepsT,  AnalyzerParameter param,  std::vector<Jet> jets,  TString tag,float event_weight){
...
void HNL_LeptonFakeRateMC::GetMuFakeRates(TString Method, Lepton*  lep, bool blepsT,  AnalyzerParameter param,  std::vector<Jet> jets,  TString tag,float event_weight){
