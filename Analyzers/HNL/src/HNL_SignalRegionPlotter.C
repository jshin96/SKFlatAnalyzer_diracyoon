...
void HNL_SignalRegionPlotter::RunULAnalysis(AnalyzerParameter param){
  ...
  RunAllSignalRegions(Inclusive, ElectronCollT,ElectronCollV,MuonCollT,MuonCollV,  TauColl,JetCollLoose, AK4_JetAllColl, JetColl,VBF_JetColl,AK8_JetColl, BJetColl, ev,METv, param, weight);
