#ifndef Vcb_BJetRegression_Mu_BReg_pt_h
#define Vcb_BJetRegression_Mu_BReg_pt_h

#include "AnalyzerCore.h"

class Vcb_BJetRegression_Mu_BReg_pt : public AnalyzerCore {
